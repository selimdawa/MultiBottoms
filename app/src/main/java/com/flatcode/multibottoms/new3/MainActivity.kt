...
import com.flatcode.multibottoms.databinding.ActivityMain4Binding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navHostFragment = supportFragmentManager.findFragmentById(R.id.main_fragment) as androidx.navigation.fragment.NavHostFragment
